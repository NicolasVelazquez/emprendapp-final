...
class ProductDetailCopyWidget extends StatefulWidget {
  ...
  @override
  _ProductDetailCopyWidgetState createState() =>
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<AppointmentsRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final productDetailCopyAppointmentsRecord = snapshot.data;
        return Scaffold(
          key: scaffoldKey,
          appBar: AppBar(
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      Expanded(
                        child: Text(
                          productDetailCopyAppointmentsRecord.appointmentType,
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      Expanded(
                        child: Text(
                          productDetailCopyAppointmentsRecord
                    ...
                    children: [
                      StreamBuilder<AppointmentsRecord>(
                        stream: AppointmentsRecord.getDocument(
                            productDetailCopyAppointmentsRecord.reference),
                        builder: (context, snapshot) {
                          // Customize what your widget looks like when it's loading.
                          if (!snapshot.hasData) {
                            return Center(
                ...
                Padding(
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      await productDetailCopyAppointmentsRecord.reference
                          .delete();
                      Navigator.pop(context);
                    },
